      ...
      if (
        ...
        if (!normalizedCategory) {
          return res.status(400).json({
            success: false,
            message:
              `Invalid product category: ${req.body.category}`,
          });
        }
